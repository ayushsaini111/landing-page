...
export async function generateMetadata() {
  ...
  const data = Data?.familyMatters ?? null;

  const title = data
    ? `${data.title} — Arshiv Legal`
    : "Family Matters — Arshiv Legal";

  const description =
    data?.description ||
    "Legal guidance for divorce, child custody, maintenance, domestic violence protection, and other family-related disputes.";
