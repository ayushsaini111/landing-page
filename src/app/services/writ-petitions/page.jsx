...
export async function generateMetadata() {
  ...
  const data = Data?.writPetitions ?? null;

  const title = data
    ? `${data.title} — Arshiv Legal`
    : "Writ Petitions — Arshiv Legal";

  const description =
    data?.description ||
    "Writ petitions including habeas corpus, mandamus, certiorari, prohibition and quo warranto to protect fundamental rights and challenge unlawful state action.";
  ...
  return {
    ...
    alternates: {
      canonical: canonicalize("/services/writ-petitions"),
    },
    openGraph: {
      title,
      description,
