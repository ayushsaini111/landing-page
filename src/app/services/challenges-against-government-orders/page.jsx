...
export async function generateMetadata() {
  ...
  const data = Data?.challengeOrders ?? null;

  const title = data
    ? `${data.title} — Arshiv Legal`
    : "Challenges Against Government Orders — Arshiv Legal";

  const description =
    data?.description ||
    "Challenge incorrect or unfair government orders, notices, and penalties with clear legal guidance and procedural support.";
