...
export async function generateMetadata() {
  ...
  const data = Data?.fundamentalRights ?? null;

  const title = data
    ? `${data.title} — Arshiv Legal`
    : "Fundamental Rights Protection — Arshiv Legal";

  const description =
    data?.description ||
    "Guidance and support in safeguarding constitutional rights when they are violated or restricted by authorities.";

  return {
    title,
    description,
    alternates: {
      canonical: canonicalize("/services/fundamental-rights-protection"),
    },
    keywords: [
      "fundamental rights",
