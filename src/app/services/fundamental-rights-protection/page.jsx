// /src/app/services/fundamental-rights-protection/page.jsx
...
export async function generateMetadata() {
  ...
  const data = Data?.subServices?.fundamentalRights ?? null;

  const title = data ? `${data.title} — Arshiv Legal` : 'Fundamental Rights Protection — Arshiv Legal';
  const description =
    data?.description ||
    'Guidance and support in safeguarding your constitutional rights when they are violated or restricted by authorities.';

  return {
    title,
    description,
    alternates: { canonical: canonicalize('/services/fundamental-rights-protection') },
    keywords: [
      'fundamental rights',
    ...
    openGraph: {
      title,
      description,
      url: canonicalize('/services/fundamental-rights-protection'),
      siteName: SEO_CONFIG.siteName,
      type: 'website',
      images: [
        {
          url: `${SEO_CONFIG.siteUrl}/images/fundamental-rights-og.jpg`,
          width: 1200,
          height: 630,
          alt: 'Fundamental Rights Protection - Arshiv Legal',
        },
      ],
    },
    twitter: {
      ...
      title,
      description,
      images: [`${SEO_CONFIG.siteUrl}/images/fundamental-rights-og.jpg`],
    },
...
// JSON-LD
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: data.title, url: canonicalize('/services/fundamental-rights-protection') },
  ]);
  ...
  const serviceSchema = {
    ...
    '@type': 'Service',
    name: data.title,
    serviceType: 'Fundamental Rights Protection',
