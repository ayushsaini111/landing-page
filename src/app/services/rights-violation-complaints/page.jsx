...
export async function generateMetadata() {
  ...
  const data = Data?.rightsViolation ?? null;

  const title = data
    ? `${data.title} — Arshiv Legal`
    : "Rights Violation Complaints — Arshiv Legal";

  const description =
    data?.description ||
    "Rights violation complaints involving misuse of authority, police misconduct, or administrative inaction. Get clear legal guidance and responsible assistance.";
  ...
  return {
    ...
    alternates: {
      canonical: canonicalize("/services/rights-violation-complaints"),
    },
    openGraph: {
      title,
      description,
