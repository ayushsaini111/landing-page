...
export async function generateMetadata() {
  ...
  const data = Data?.cheatingHarassment ?? null;

  const title = data
    ? `${data.title} — Arshiv Legal`
    : "Cheating, Threats & Harassment Cases — Arshiv Legal";

  const description =
    data?.description ||
    "Legal guidance and representation for cheating, threats, harassment, and related criminal matters.";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Cheating, Threats & Harassment Cases - Arshiv Legal",
        },
      ],
    },
    twitter: {
