...
export async function generateMetadata() {
  ...
  const data = Data?.documentsLicensing ?? null;

  const title = data
    ? `${data.title} — Arshiv Legal`
    : "Government Document & Licensing Issues — Arshiv Legal";

  const description =
    data?.description ||
    "Assistance with government documents, licensing issues, corrections, updates, and application support.";

  return {
    title,
    description,
    alternates: {
      canonical: canonicalize("/services/government-document-licensing-issues"),
    },
    keywords: [
